	     ...
	     $.ajax({
				...
				success:function(result){
					if(result.code == 1){
						...
						// 获取值
						var chargeId = refund.chargeId;
						var solderName = refund.solderName;
						var chargeTime = dateFormatter(refund.chargeTime);
						var chargeReason = refund.chargeReason;
						var chargeNumber = refund.chargeNumber;
